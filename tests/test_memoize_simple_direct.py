...
# -*- coding: utf-8 -*-
"""
Test the memoize_simple function directly without going through __init__.
This avoids the issue with the contracts module.
"""
...
# Direct import of the module to bypass __init__ issues
